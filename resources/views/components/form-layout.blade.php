...
<body class="antialiased pattern min-h-screen">
    <nav class="bg-white/80 backdrop-blur-md border-b border-gray-100 fixed w-full z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="{{ route('reminders.index') }}" class="inline-flex items-center text-gray-600 hover:text-gray-900 font-medium">
    ...
    <div class="pt-24 pb-12">
        <div class="max-w-2xl mx-auto">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold gradient-text mb-2">{{ $title }}</h1>
                <p class="text-gray-600">{{ $description ?? '' }}</p>
            </div>
            
            <div class="bg-white rounded-xl shadow-xl border-2 border-gray-100" data-aos="fade-up">
                {{ $slot }}
            </div>
        </div>
    </div>
